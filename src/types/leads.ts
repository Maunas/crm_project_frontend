...
export interface Lead {
  ...
  // Referencia legible por el usuario, ej. "L-0001" (backend/AGENTS.md §49-bis). Puede venir
  // null en leads insertados directo por test fixtures que no pasan por lead_service.create() --
