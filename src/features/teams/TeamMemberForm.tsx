...
interface TeamMemberFormSidebarProps {
    ...
    // public_uuid de User (ver comentario en TeamMemberList.tsx).
...
interface FormValues {
    // public_uuid de User (UserPublic.id ya lo devuelve así, aunque su tipo declarado diga
    // number -- ver backend/AGENTS.md §18/deuda de tipos).
    user_id: string | null,
    role: string
}
