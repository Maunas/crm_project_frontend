...
export const NATIVE_LEAD_FIELDS: LeadField[] = [
    ...
    { ...base, id: -8, name: 'Usuario Modificador', field_type_code: 'NATIVE_ID', field_subtype_code: null, field_type: NATIVE_TYPE, nativeKey: 'updated_by' },
]
 ...
 * son hechos de auditoría, no tiene sentido "setearlos" a mano. 
 * Debe reflejar exactamente `WRITABLE_NATIVE_FIELD_IDS` de `backend/app/core/native_lead_fields.py`.
 */
 ...
 * No existe una sección de base de datos para esto -- son 3 grupos fijos definidos en frontend.
 */
