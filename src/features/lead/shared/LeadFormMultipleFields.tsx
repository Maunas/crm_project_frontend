...
export const LeadFormRelatedLead = <T extends FieldValues>
    ({ control, name, label, options, required = false, size = "medium", shortTitle = false, errorMessage }: LeadFormLeadProps<T>) => {
...
export const LeadFormSelector = <T extends FieldValues>(
    { control, name, label, options, subtype, required = false, size = "medium", errorMessage }: LeadFormSelectorProps<T>
) => {
...
export const LeadFormNomenclator = <T extends FieldValues>({ control, name, label, options,
    multiple = false, required = false, size = "medium", errorMessage }: LeadFormNomenclatorProps<T>) => {
...
export const LeadFormCheckbox = <T extends FieldValues>({ control, name, label, options,
    multiple = false, required = false, size = "medium", errorMessage }: LeadFormCheckboxProps<T>) => {
