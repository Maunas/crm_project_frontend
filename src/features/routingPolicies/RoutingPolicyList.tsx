...
export const RoutingPolicyList = () => {
    ...
    // team/campaign en la URL son el public_uuid real (Team.id/Campaign.id, Fase 1/3) --
    // antes se forzaban a Number() y nunca matcheaban contra nada (deuda ya documentada en
    // backend/AGENTS.md §18, resuelta acá aprovechando policy.target_team/campaign anidados).
