...
export const RoutingPolicyForm = ({ existingPolicy, initialCampaignId, submit, onCancel }: RoutingPolicyFormProps) => {
    ...
    const defaultValues = useMemo<FormValues>(() => ({
        ...
        // target_team_id/campaign_id de existingPolicy siguen siendo la FK embebida sin
        // migrar, pero ahora el Response también trae el objeto anidado target_team/campaign
        // con el uuid real -- se usa ese en vez de forzar re-selección (patrón anterior, ya no
        // hace falta).
        ...
        // Cada condición ahora trae el objeto anidado lead_field con el uuid real -- se usa
        // para precargar en vez de forzar re-selección (patrón anterior, ya no hace falta
