...
interface NomenclatorItemParams extends ListParams {
    // FK a Nomenclator/NomenclatorItem: public_uuid desde Fase 3.
...
// id es el public_uuid del nomenclador (rutas genéricas de BaseController, ver backend/AGENTS.md §17-18).
...
// id es el public_uuid del ítem (rutas genéricas de BaseController, ver backend/AGENTS.md §17-18).
