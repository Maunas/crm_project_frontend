...
// id es el public_uuid del campo (rutas genéricas de BaseController, ver backend/AGENTS.md §17-18).
...
// ids son public_uuid de LeadField (BulkIdsRequest.ids ya es list[str] en el backend, ver §17).
