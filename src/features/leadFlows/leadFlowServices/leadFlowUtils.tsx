...
// Todo lo que viene de acá ya existe en el backend -> isNew: false siempre. Ver
// FlowEditorState.isNew / backend/AGENTS.md §18 para el porqué (antes se detectaba por
// guiones en tempId, dejó de servir cuando LeadState.id pasó a ser uuid).
...
// interno viejo de LeadState -- FK embebida sin migrar (deuda catalogada, backend/AGENTS.md
// §18) -- así que ya no sirven para correlacionar contra el tempId (uuid) de los nodos. Los
// objetos anidados from_state/to_state sí tienen su .id como uuid, que es lo que necesita
// FlowEditor para conectar la transición al nodo correcto.
