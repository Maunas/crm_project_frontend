 ...
 * línea divisora suave + título en letra pequeña, mismo criterio visual que ya se usa en el
 * bloque de metadatos del detalle del lead (pedido del usuario 2026-07-25). Se usa tanto dentro
 * de un `<Select>` (envuelto en `ListSubheader`, ver `renderGroupedMenuItems`) como en el
 * `renderGroup` de un Autocomplete (ver `renderFieldSectionGroup`).
 */
 ...
 * que usa la implementación default de MUI.
 */
