//Extraido de https://mui.com/material-ui/react-switch/
        ...
        '&.Mui-checked': {
            ...
            '& .MuiSwitch-thumb:before': {
                backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
                    theme.palette.contrast["50"],
                )}" d="M4.2 2.5l-.7 1.8-1.8.7 1.8.7.7 1.8.6-1.8L6.7 5l-1.9-.7-.6-1.8zm15 8.3a6.7 6.7 0 11-6.6-6.6 5.8 5.8 0 006.6 6.6z"/></svg>')`,
            },
            '& + .MuiSwitch-track': {
                opacity: 1,
                backgroundColor: theme.palette.contrast["300"],
                ...theme.applyStyles('dark', {
                    backgroundColor: theme.palette.contrast.lighter,
                }),
            },
        },
    },
