...
export const updateWorkspace = async (body: WorkspacePost, id: number): Promise<Workspace> => {
...
export const updateOrganization = async (body: OrganizationPost, id: number): Promise<Organization> => {
...
export const getCampaigns = async<T extends Params>(params?: T): Promise<T["detailed"] extends true ? Campaign[] : CampaignDetailed[]> => {
    ...
    return orderList(campaigns.data.items, "id")
}
...
export const updateCampaign = async (body: CampaignPost, id: number): Promise<Campaign> => {
